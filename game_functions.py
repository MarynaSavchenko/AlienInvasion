...
def check_events(ai_settings, screen, ship, bullets, button, stats, aliens):
    """Watch for events"""
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(button, mouse_x, mouse_y, stats, aliens, bullets, ai_settings, ship, screen)

def check_play_button(button, mouse_x, mouse_y, stats, aliens, bullets, ai_settings, ship, screen):
    if button.rect.collidepoint(mouse_x, mouse_y) :
       start_game(button, mouse_x, mouse_y, stats, aliens, bullets, ai_settings, ship, screen)

def start_game( stats, aliens, bullets, ai_settings, ship, screen):
...
def check_keydown_events(event, ai_settings, screen, ship, bullets, stats, aliens,):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        start_game(stats, aliens, bullets, ai_settings, ship, screen)
...
def update_screen(ai_settings, screen, ship, aliens, bullets, button, stats):
    # Redraw the screen
